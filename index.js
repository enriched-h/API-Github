    ...
    if (response.ok) {
        ...
        document.getElementById("result").innerHTML = `
            <div class="profile">
                ...
                <div class="media">
                    <p>
                        <span class="media-value">${data.location || 'Location: Not Available'}</span>
                    </p>

                    <p><a target="_blank" href="${data.blog || '#'}"><span class="media-value">${data.blog || 'Blog: Not Available'}</span></a>
                    </p>

                    <p>
                        <span class="media-value">${data.twitter_username || 'Twitter: Not Available'}</span>
                    </p>
                    
                    <p>
                        <span class="media-value">${data.company || 'Company: Not Available'}</span>
                    </p>
                </div>
            </div>
        </div>
